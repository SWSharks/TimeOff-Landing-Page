      ...
      {props.sectionList.map((sectionItem, index) => {
        return index % 2 === 0 ? (
          <SectionItemImageOnTheLeft
            ...
            backgroundColor={"rgb(14,217,139,0.7)"}
          />
        ) : (
...
function Desktop() {
  ...
  return (
    <Layout style={{ minWidth: "1000px" }} className="App">
      <Affix offsetTop={0}>
      ...
      <Layout.Content>
        ...
        >
          <Col justify="center" align="middle" style={{ maxWidth: "2000px" }}>
            <Col style={{ width: "90%" }}>
              <Row justify="center" style={{ padding: "0px 50px" }}>
